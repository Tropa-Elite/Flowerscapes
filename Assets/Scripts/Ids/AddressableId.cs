...
namespace Game.Ids
{
	...
	public static class AddressableConfigLookup
	{
			...
			{"GenerateIds", new List<AddressableConfig>
				{
					...
					new AddressableConfig(6, "Addressables/Prefabs/Piece.prefab", "Assets/Addressables/Prefabs/Piece.prefab", typeof(UnityEngine.GameObject), new [] {"GenerateIds"}),
					new AddressableConfig(7, "Addressables/Configs/UiConfigs.asset", "Assets/Addressables/Configs/UiConfigs.asset", typeof(GameLovers.UiService.UiConfigs), new [] {"GenerateIds"}),
					new AddressableConfig(8, "Addressables/Configs/SceneAssetConfigs.asset", "Assets/Addressables/Configs/SceneAssetConfigs.asset", typeof(Game.Configs.SceneAssetConfigs), new [] {"GenerateIds"}),
					new AddressableConfig(9, "Addressables/Configs/GameConfigs.asset", "Assets/Addressables/Configs/GameConfigs.asset", typeof(Game.Configs.GameConfigs), new [] {"GenerateIds"}),
					new AddressableConfig(10, "Addressables/Configs/DataConfigs.asset", "Assets/Addressables/Configs/DataConfigs.asset", typeof(Game.Configs.DataConfigs), new [] {"GenerateIds"}),
				}.AsReadOnly()}
		});
		...
		private static readonly IList<AddressableConfig> _addressableConfigs = new List<AddressableConfig>
		{
			...
			new AddressableConfig(9, "Addressables/Scenes/Game.unity", "Assets/Addressables/Scenes/Game.unity", typeof(UnityEngine.SceneManagement.Scene), new [] {"GenerateIds"}),
			new AddressableConfig(10, "Addressables/Scenes/Menu.unity", "Assets/Addressables/Scenes/Menu.unity", typeof(UnityEngine.SceneManagement.Scene), new [] {"GenerateIds"})
		}.AsReadOnly();
	}
}
