...
namespace Game.Ids
{
	public enum AddressableId
	{
		...
		Addressables_Prefabs_UI_Pause_Screen,
			...
			{"GenerateIds", new List<AddressableConfig>
				{
					...
					new AddressableConfig(2, "Addressables/Prefabs/UI/Pause Screen.prefab", "Assets/Addressables/Prefabs/UI/Pause Screen.prefab", typeof(UnityEngine.GameObject), new [] {"GenerateIds"}),
